...
class PilesControllerTest < ActionController::TestCase
  ...
  test "should create pile" do
    assert_difference('Pile.count') do
      post :create, pile: { card_id: @pile.card_id, card_order: @pile.card_order, card_pile_id: @pile.card_pile_id }
    end
  ...
  test "should update pile" do
    patch :update, id: @pile, pile: { card_id: @pile.card_id, card_order: @pile.card_order, card_pile_id: @pile.card_pile_id }
    assert_redirected_to pile_path(assigns(:pile))
  end
