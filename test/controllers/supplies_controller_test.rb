...
class SuppliesControllerTest < ActionController::TestCase
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post :create, supply: { card_pile_id: @supply.card_pile_id, game_id: @supply.game_id, supply_type: @supply.supply_type }
    end
  ...
  test "should update supply" do
    patch :update, id: @supply, supply: { card_pile_id: @supply.card_pile_id, game_id: @supply.game_id, supply_type: @supply.supply_type }
    assert_redirected_to supply_path(assigns(:supply))
  end
